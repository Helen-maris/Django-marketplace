...
# 1.1 Sellers
user1 = User.objects.create_superuser('user1', 'user1_mail@mail.com', 'userpassword')
user1.save()
...
>>> from my_project.tasks import sum_values
>>> result = sum_values.apply()
>>> result
<EagerResult: 7f5c4324-bc7d-428d-9f7f-bab853b76309>

>>> from my_project.tasks import print_message
>>> print_message.apply()
